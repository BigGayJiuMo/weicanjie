...
public interface RefundRecordMapper {
    ...
    @Insert("INSERT INTO refund_record (order_id, user_id, restaurant_id, refund_reason, refund_remark, status) " +
            "VALUES (#{orderId}, #{userId}, #{restaurantId}, #{refundReason}, #{refundRemark}, #{status})")
